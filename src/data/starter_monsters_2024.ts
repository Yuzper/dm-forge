...
export const STARTER_MONSTERS: StarterMonster[] = [
    ...
    variants: [
      {
        ...
        statblock: {
          ac: 15, acNote: 'leather armour, shield', hp: 10, hpDice: { count: 3, die: 6, bonus: 0 }, speed: '30 ft.',
      ...
      },
      {
        ...
        statblock: {
          ...
          traits: [],
          actions: [
            { name: 'Multiattack', desc: 'The goblin boss makes two attacks, using Scimitar or Javelin in any combination.' },
            { name: 'Scimitar', desc: 'Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 5 (1d6 + 2) slashing damage.' },
          ...
          bonusActions: [
            ...
            { name: 'Redirect Attack', desc: 'The goblin boss chooses an ally within 5 ft. of itself. The boss and ally swap places, and the ally becomes the target of one attack that was directed at the boss this turn.' },
          ],
          reactions: [], legendaryActions: [], cantrips: [], preparedSpells: [],
        },
      },
  ...
  },
  {
    ...
    content: p(
      ...
      'The 2024 revision removes Sunlight Sensitivity from kobolds, making them slightly more versatile. They gain the Scurry bonus action, emphasising hit-and-run tactics.',
    ),
    variants: [
      {
        name: 'Kobold', cr: '1/8', loot_table_name: 'Goblinoid',
        statblock: {
          ac: 12, acNote: '', hp: 7, hpDice: { count: 3, die: 6, bonus: -3 }, speed: '30 ft.',
          ...
          damageImmunities: '', damageResistances: '', conditionImmunities: '',
          traits: [{ name: 'Pack Tactics', desc: "The kobold has advantage on attack rolls against a creature if at least one of the kobold's allies is within 5 ft. of the creature and the ally isn't incapacitated." }],
          actions: [
          ...
          bonusActions: [{ name: 'Scurry', desc: 'The kobold moves up to half its speed without provoking opportunity attacks.' }],
          reactions: [], legendaryActions: [], cantrips: [], preparedSpells: [],
        },
      },
    ],
  },
  {
    ...
    content: p(
      ...
      'The 2024 orc gains Multiattack and its Aggressive trait moves to a Bonus Action, making it both more dangerous and more action-efficient. Higher HP reflects the general upward trend in monster durability.',
    ),
    variants: [
      {
        name: 'Orc Warrior', cr: '1/2', loot_table_name: 'Goblinoid',
        statblock: {
          ac: 13, acNote: 'hide armour', hp: 21, hpDice: { count: 3, die: 8, bonus: 9 }, speed: '30 ft.',
          ...
          bonusActions: [{ name: 'Aggressive', desc: 'The orc moves up to its speed toward a hostile creature that it can see.' }],
          reactions: [], legendaryActions: [], cantrips: [], preparedSpells: [],
        },
      },
    ],
  },
  {
    ...
    tracks: { Vitality: 'Living', Disposition: 'Hostile', Creature_Type: 'Humanoid', Size: 'Medium', Habitat: 'Mountain' },
    content: p(
      'Hobgoblins are the disciplined, militaristic cousins of goblins — taller, stronger, and organised into rigid warbands ruled by martial law.',
      'The 2024 hobgoblin warrior trades Martial Advantage for Pack Tactics and gains a Multiattack, making it a reliable front-line soldier that rewards fighting alongside its fellows.',
    ),
    variants: [
      {
        name: 'Hobgoblin Warrior', cr: '1/2', loot_table_name: 'Goblinoid',
        statblock: {
          ...
          damageImmunities: '', damageResistances: '', conditionImmunities: '',
          traits: [{ name: 'Pack Tactics', desc: "The hobgoblin has advantage on an attack roll against a creature if at least one of the hobgoblin's allies is within 5 ft. of the creature and the ally isn't incapacitated." }],
          actions: [
            { name: 'Multiattack', desc: 'The hobgoblin makes two Longsword or Longbow attacks.' },
  ...
  },
  {
    ...
    content: p(
      'Bugbears are the largest and most brutish of the goblinoids — hulking, hairy ambushers who creep through the dark on surprisingly silent feet before falling upon their prey.',
      'The 2024 bugbear warrior gains higher HP and a Multiattack, while keeping the devastating Surprise Attack that makes it so dangerous to ambushed parties.',
    ),
    variants: [
      {
        name: 'Bugbear Warrior', cr: '1', loot_table_name: 'Goblinoid',
        statblock: {
          ac: 16, acNote: 'hide armour, shield', hp: 33, hpDice: { count: 6, die: 8, bonus: 6 }, speed: '30 ft.',
          ...
          damageImmunities: '', damageResistances: '', conditionImmunities: '',
          traits: [{ name: 'Surprise Attack', desc: 'If the bugbear surprises a creature and hits it with an attack during the first round of combat, the target takes an extra 7 (2d6) damage from the attack.' }],
          actions: [
            { name: 'Multiattack', desc: 'The bugbear makes two Morningstar or Javelin attacks.' },
            { name: 'Morningstar', desc: 'Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 6 (1d8 + 2) piercing damage.' },
  ...
  },
  {
    ...
    content: p(
      'Drow are dark elves who dwell in the lightless depths of the Underdark, worshipping the Spider Queen and scheming endlessly against rival houses.',
      'The 2024 drow keeps its signature poisoned hand crossbow and innate magic, fighting from the shadows to drop sentries before raising the alarm.',
    ),
    variants: [
      {
  ...
  },
  {
    ...
    content: p(
      ...
      'The 2024 skeleton gains Multiattack, making it more threatening at low CR. Higher HP reflects the revised baseline for undead. Radiant damage remains particularly effective against them.',
    ),
    variants: [
      {
        name: 'Skeleton', cr: '1/4', loot_table_name: 'Undead',
        statblock: {
          ac: 13, acNote: 'armour scraps', hp: 15, hpDice: { count: 2, die: 8, bonus: 6 }, speed: '30 ft.',
  ...
  },
  {
    ...
    content: p(
      'Zombies are the animated corpses of dead humanoids, created through dark necromantic magic. Slow, shambling, and relentless, they are driven only by the need to kill.',
      'The 2024 zombie has higher HP and its Slam now uses a d8, reflecting the general upward scaling of undead. Its role remains the same: expendable shock troops designed to wear down the party.',
    ),
    variants: [
      {
        name: 'Zombie', cr: '1/4', loot_table_name: 'Undead',
        statblock: {
          ac: 8, acNote: '', hp: 26, hpDice: { count: 4, die: 8, bonus: 8 }, speed: '20 ft.',
          ...
          actions: [{ name: 'Slam', desc: 'Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 5 (1d8 + 1) bludgeoning damage.' }],
          bonusActions: [], reactions: [], legendaryActions: [], cantrips: [], preparedSpells: [],
        },
      },
    ],
  ...
  },
  {
    ...
    content: p(
      ...
      'The 2024 ghoul gains a Multiattack, letting it claw and bite in the same turn, and its paralysing bite no longer spares elves — making it a far deadlier pack hunter.',
    ),
    variants: [
      {
        ...
        statblock: {
          ...
          traits: [],
          actions: [
            { name: 'Multiattack', desc: 'The ghoul makes one Bite attack and one Claws attack.' },
            { name: 'Bite', desc: 'Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 9 (2d6 + 2) piercing damage, and the target must succeed on a DC 10 Constitution saving throw or be paralyzed for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.' },
            { name: 'Claws', desc: 'Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (2d4 + 2) slashing damage.' },
          ],
          bonusActions: [], reactions: [], legendaryActions: [], cantrips: [], preparedSpells: [],
        },
      },
  ...
  },
  {
    ...
    content: p(
      'Wolves are pack hunters found in temperate forests, hills, and plains. They use pack tactics to bring down prey far larger than themselves.',
  ...
  },
  {
    ...
    content: p(
      'Giant spiders lurk in deep caves, abandoned ruins, and the canopies of dark forests. They spin webs to trap prey, then inject paralytic venom before wrapping their victims.',
      'The 2024 giant spider has notably higher poison damage on its bite (4d8 vs 2d8), making it significantly more lethal. Its role as a web-setter ambush predator is unchanged.',
    ),
    variants: [
      {
        name: 'Giant Spider', cr: '1', loot_table_name: 'Beast',
        statblock: {
          ac: 14, acNote: 'natural armour', hp: 32, hpDice: { count: 5, die: 10, bonus: 5 }, speed: '30 ft., climb 30 ft.',
  ...
  },
  {
    ...
    content: p(
      ...
      'Use this stat block for highwaymen, pirates, or hired muscle. The 2024 bandit has marginally higher HP.',
    ),
    variants: [
      {
        name: 'Bandit', cr: '1/8', loot_table_name: 'Bandit',
        statblock: {
          ac: 12, acNote: 'leather armour', hp: 13, hpDice: { count: 3, die: 8, bonus: 0 }, speed: '30 ft.',
  ...
  },
  {
    ...
    content: p(
      'Guards include members of a city watch, sentries in a citadel, and soldiers in a lord\'s army.',
      'Use guards to populate castles, city gates, noble estates, and warehouses. The 2024 guard has slightly higher HP.',
    ),
    variants: [
      {
        name: 'Guard', cr: '1/8', loot_table_name: 'Soldier / Guard',
        statblock: {
          ac: 16, acNote: 'chain shirt, shield', hp: 13, hpDice: { count: 3, die: 8, bonus: 0 }, speed: '30 ft.',
          ...
          damageImmunities: '', damageResistances: '', conditionImmunities: '',
          traits: [],
          actions: [{ name: 'Spear', desc: 'Melee or Ranged Weapon Attack: +3 to hit, reach 5 ft. or range 20/60 ft., one target. Hit: 4 (1d6 + 1) piercing damage, or 5 (1d8 + 1) piercing damage if used with two hands.' }],
          bonusActions: [], reactions: [], legendaryActions: [], cantrips: [], preparedSpells: [],
        },
      },
    ],
  ...
  },
  {
    ...
    content: p(
      'Giant rats are aggressive scavengers that lurk in sewers, cellars, dungeons, and ruined buildings. Drawn to filth and carrion, a nest of giant rats can strip a body to the bone within hours.',
      'Frequently found infesting a villain\'s lair or in service to wererats. Pack tactics makes them more dangerous than their low CR suggests.',
    ),
    variants: [
      {
        name: 'Giant Rat', cr: '1/8', loot_table_name: 'Beast',
        statblock: {
          ac: 12, acNote: '', hp: 9, hpDice: { count: 3, die: 6, bonus: 0 }, speed: '30 ft.',
          str: 7, dex: 15, con: 11, int: 2, wis: 10, cha: 4,
          savingThrows: '', skills: '', senses: 'Darkvision 60 ft., Passive Perception 10', languages: '—',
          damageImmunities: '', damageResistances: '', conditionImmunities: '',
          traits: [
